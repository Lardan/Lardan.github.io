	...
	<div class="well no-padding">
		...
		<form method="post" action="/admin/casesedit" class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="images" value="" placeholder="..." class="input-block-level">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="nomer" value="" placeholder="..." class="input-block-level">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="status" value="" placeholder="..." class="input-block-level">
